...
public enum ColorPalette {
	BLACK(Color.BLACK), GRAY_1(new Color(255 / 10, 255 / 10,
			255 / 10)), SEAFOAM(mixColors(Color.GREEN, Color.CYAN)), GRAY_2(
					new Color((255 / 10) * 2, (255 / 10) * 2,
							(255 / 10) * 2)), GRAY_3(new Color((255 / 10) * 3,
									(255 / 10) * 3, (255 / 10) * 3)), GRAY_4(
											new Color((255 / 10) * 4,
													(255 / 10)
															* 4,
											(255 / 10) * 4)), GRAY_5(new Color(
													(255 / 10) * 5,
													(255 / 10) * 5,
													(255 / 10) * 5)), GRAY_6(
															new Color(
